      ...
      <div className="wrap">
        <header className="header">
          <div className="container-fluid">
            <a href="https://impc.vn/vi" className="logo">
              <svg
                width="162"
                height="48"
                viewBox="0 0 162 48"
              ...
              <div className="header-top">
                <div className="nav-wrap">
                  <nav className="main-nav">
                    <ul>
                      <li>
                        <a href="https://www.prco.com/about/">About</a>
                      </li>
                      <li>
                        <a href="https://www.prco.com/about/">What We Do</a>
                      </li>
                      <li>
                        <a href="https://www.prco.com/about/">Portfolio</a>
                      </li>
                      <li>
                        <a href="https://www.prco.com/about/">Contact</a>
                      </li>
                    </ul>
                  </nav>
                </div>
        ...
        <div className="block block-1">
          <div className="grid-container">
            ...
            <div className="grid-item grid-item--2 flex">
              <a href="#" className="text">
                <h2>Our services</h2>
                <div className="text-button">
            ...
            <div className="grid-item grid-item--3 flex">
              <h3 className="text">
        ...
        <div className="block block-2">
          <div className="grid-container">
            <div className="grid-item grid-item--1 flex">
              <h3 className="text-brand">VSIP I</h3>
              <div className="image image-color">
                <img src={img1} alt="" />
              </div>
            </div>
            <div className="grid-item grid-item--2 flex">
              <h3 className="text-brand">VSIP II</h3>
              <div className="image image-color">
                <img src={img2} alt="" />
              </div>
            </div>
            <div className="grid-item grid-item--3 flex">
              <h3 className="text-brand">VSIP III</h3>
              <div className="image image-color">
                <img src={img3} alt="" />
              </div>
            </div>
            <div className="grid-item grid-item--4 flex">
              <h3 className="text-brand">VSIP IV</h3>
              <div className="image image-color">
                <img src={img4} alt="" />
              </div>
            </div>
            <div className="grid-item grid-item--4 flex">
              <h3 className="text-brand">VSIP V</h3>
              <div className="image image-color">
                <img src={img5} alt="" />
              </div>
            </div>
                ...
                <nav>
                  <ul className="flex-column">
                    <li class="">
                      <a
                        rel="privacy-policy"
                        href="https://www.prco.com/privacy-policy/"
                      >
                        Privacy Policy
                      </a>
                    </li>
